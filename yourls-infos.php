...
function yourls_html_head_info( $context = 'index', $title = '' ) {
	...
	// Page title
	$_title = 'YoloMe.me - The YoloMeme URL Enhancer';
...
<head>
	...
	<meta name="author" content="YoloMe.me" />
	<meta name="generator" content="YOURLS <?php echo YOURLS_VERSION ?> with extra YOLO" />
	<meta name="description" content="The YoloMeme URL Enhancer' | <?php yourls_site_url(); ?>" />
...
yourls_html_head_info( 'infos', yourls_s( 'Statistics for %s', YOURLS_SITE.'/'.$keyword ) );
//yourls_html_logo();
//yourls_html_menu();
?>
<h1> YoloMeme Stats!!1!!1! </h1>
<h2 id="informations"><?php echo yourls_esc_html( $title ); ?></h2>

<p><span class="label"><?php yourls_e( 'Enhanced URL'); ?>:</span> 
<?php if( $aggregate ) {
	$i = 0;
...
<p id="longurl"><span class="label"><?php yourls_e( 'Boring URL'); ?>:</span>  <?php yourls_html_link( $longurl, yourls_trim_long_string( $longurl ), 'longurl' ); ?></p>
